...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Obat</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">List Obat</h1>
    ...
    <div
        ...
        <div class="flex items-center mb-4 sm:mb-0">
            ...
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span
                    class="font-semibold text-gray-900 dark:text-white">{{ $medicines->firstItem() }} -
                    {{ $medicines->lastItem() }}</span> of <span
                    class="font-semibold text-gray-900 dark:text-white">{{ $medicines->total() }}</span></span>
        </div>
    ...
    @foreach ($medicines as $medicine)
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ $medicine->name }}" placeholder="Type product name" required="">
                    </div>
                    <div>
        ...
        <div id="drawer-delete-product-default-{{ $loop->iteration }}"
            ...
            <form id="delete-form-{{ $loop->iteration }}" action="{{ route('admin.medicine.destroy', $medicine->id) }}"
                method="POST">
                @csrf
                @method('DELETE')
            </form>
    ...
    <div id="drawer-create-product-default"
        ...
        tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
        <h5 id="drawer-label"
            class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Obat
            Baru</h5>
