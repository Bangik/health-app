...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Informasi</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">List Informasi</h1>
                            ...
                            @foreach ($knowledges as $knowledge)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <img class="h-auto max-w-20 rounded-lg" src="{{ $knowledge->image_url }}"
                                            alt="No Image">
    ...
    <div
        ...
        <div class="flex items-center mb-4 sm:mb-0">
            <a href="{{ $knowledges->previousPageUrl() }}"
            ...
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span
                    class="font-semibold text-gray-900 dark:text-white">{{ $knowledges->firstItem() }} -
                    {{ $knowledges->lastItem() }}</span> of <span
                    class="font-semibold text-gray-900 dark:text-white">{{ $knowledges->total() }}</span></span>
        </div>
    ...
    @foreach ($knowledges as $knowledge)
        ...
        <div id="drawer-update-product-default-{{ $loop->iteration }}"
            ...
            <form action="{{ route('admin.knowledge.update', $knowledge->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            value="{{ $knowledge->title }}" placeholder="Ketik judul informasi" required="">
                    </div>
                    <div>
                        <label for="content"
                        ...
                        <textarea id="content" rows="4" name="content"
                            ...
                            placeholder="Ketik konten kamu">{{ $knowledge->content }}</textarea>
                    </div>
                    <div>
        ...
        <div id="drawer-delete-product-default-{{ $loop->iteration }}"
            ...
            <form id="delete-form-{{ $loop->iteration }}"
                action="{{ route('admin.knowledge.destroy', $knowledge->id) }}" method="POST">
                @csrf
                @method('DELETE')
            </form>
            {{-- with method --}}
